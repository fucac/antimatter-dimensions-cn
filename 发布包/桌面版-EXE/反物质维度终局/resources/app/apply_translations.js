...
const transPath = 'c:/Users/Rarin/Downloads/AntimatterDimensionsEndgameUpdate-master/AntimatterDimensionsEndgameUpdate-master/translations.txt';

let content = fs.readFileSync(newsPath, 'utf8');
const raw = fs.readFileSync(transPath, 'utf8');

// Only apply to section after id: "ai637"
const marker = 'id: "ai637"';
...
// Parse pipe-delimited translations: OLD ||| NEW
...
for (const line of lines) {
  ...
  if (after.includes(old)) {
    ...
    notFound.push(old.substring(0, 50));
  }
}
