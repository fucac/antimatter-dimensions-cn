...
<template>
  <ModalWrapperOptions>
    ...
    <div class="o-primary-btn o-primary-btn--option-wide o-primary-btn--slider">
      <b>{{ formatInt(parseInt(repeatBuffer)) }} 条消息重复缓冲</b>
      <SliderComponent
    ...
    <div class="o-primary-btn o-primary-btn--option-wide o-primary-btn--slider">
      <b>{{ formatPercents(parseFloat(AIChance)) }} AI 消息</b>
      <SliderComponent
        class="o-primary-btn--slider__slider"
    ...
    <div class="o-primary-btn o-primary-btn--option-wide o-primary-btn--slider">
      <b>{{ formatPercents(parseFloat(ENDChance)) }} 终局消息</b>
      <SliderComponent
        class="o-primary-btn--slider__slider"
    ...
    <div class="o-primary-btn o-primary-btn--option-wide o-primary-btn--slider">
      <b>{{ formatPercents(parseFloat(StoryChance)) }} 生命与午夜的故事 </b>
      <SliderComponent
        class="o-primary-btn--slider__slider"
    ...
    <div class="o-primary-btn o-primary-btn--option-wide o-primary-btn--slider">
      <b>{{ formatPercents(parseFloat(MatureChance)) }} 成熟消息 </b>
      <SliderComponent
        class="o-primary-btn--slider__slider"
