...
<template>
  ...
  >
    ...
    >
      ...
      <div v-if="!isCapped">
        <div>
          {{ name }} 拥有 {{ quantify("记忆", memories, 2) }}
        </div>
      </div>
      <div
        v-if="!isCapped"
            ...
            >
              ...
              >
                ...
                <div class="c-ra-pet-upgrade__tooltip__description">
                  获得 {{ formatPercents(0.3) }} 更多记忆
                </div>
                <div class="c-ra-pet-upgrade__tooltip__footer">
                  花费：{{ quantify("记忆", memoryUpgradeCost, 2, 2) }}
          ...
          <div class="l-ra-pet-upgrade c-ra-pet-upgrade__bottom">
            ...
            >
              ...
              >
                ...
                <div class="c-ra-pet-upgrade__tooltip__description">
                  获得 {{ formatPercents(0.5) }} 更多记忆碎片
                </div>
                <div class="c-ra-pet-upgrade__tooltip__footer">
                  花费：{{ quantify("记忆", chunkUpgradeCost, 2, 2) }}
      ...
      <div v-if="!isCapped">
        <div>
          {{ quantify("记忆碎片", memoryChunks, 2, 2) }}, {{ quantify("记忆", memoriesPerSecond, 2, 2) }}/秒
        </div>
        <div>
          每秒获得 {{ quantify("记忆碎片", memoryChunksPerSecond, 2, 2) }}/秒
