    ...
    >
      <div class="c-armageddon-container">
        ...
        <div class="c-armageddon-resources-container">
          <div>
            你拥有 <span class="c-remnants-amount">{{ format(remnants, 2) }}</span> {{ pluralize("Remnant", remnants) }}。
          </div>
          <div>
            你拥有 <span class="c-remnants-amount">{{ format(realityShards, 2) }}</span> {{ pluralize("Reality Shard", realityShards) }}。
