...
<template>
  <div class="l-reality-upgrade-grid">
    ...
    <div class="c-info-text">
      你已触及现实的极限，最多只能持有 {{ format(capRM) }} 现实机器。
      <br>
      超过 {{ format(baseRMCap) }} 后多出的现实机器会提升你能拥有的虚幻机器上限。
      <br>
      虚幻机器会随时间被动获取直到达到上限，但越接近上限，获取速度越慢（指数衰减）。
      <br>
      每 {{ formatInt(scaleTime) }} 秒，你当前虚幻机器与上限之间的差值会减半。
      <br>
      <br>
      前两行升级可无限购买，其余为带有要求的一次性升级。
      <br>
      此处的升级与现实升级玩法和视觉效果相同，但花费虚幻机器而非现实机器。
