...
export default {
  ...
  computed: {
    ...
    boughtTooltip() {
      ...
      if (this.isContinuumActive) return "连续统产出你所有的反物质维度";
      return `已购买 ${quantifyHybridLarge("time", this.bought)}`;
    },
    costUnit() {
    ...
    buttonValue() {
      ...
      const prefix = this.showCostTitle(this.buyUntil10 ? this.until10Cost : this.singleCost) ? "成本: " : "";
