...
export default {
  ...
  computed: {
    parts() {
      ...
      return [
        celestialReality(Teresa, "特蕾莎的", "teresa"),
        celestialReality(Effarig, "鹿颈长的", "effarig"),
        celestialReality(Enslaved, "无名氏的", "enslaved"),
        celestialReality(V, "薇的", "v"),
        celestialReality(Ra, "太阳神的", "ra"),
        celestialReality(Laitela, "莱特拉的", "laitela"),
        {
          name: () => "毁灭的现实",
          isActive: token => token,
        ...
        celestialReality(Alpha, "阿尔法的", "alpha"),
        {
          name: () => "鹿颈长的终局",
          isActive: token => token,
        ...
        {
          name: () => `虚空${LHC.nullifiedVoidRunning ? "（无效化）" : ""}`,
          isActive: token => token,
