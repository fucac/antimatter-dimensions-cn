...
export const Alpha = {
  ...
  get stageNames() {
    return ["达到第4维度提升", "达到第5维度提升", "达到第1反物质星系", "达到无限",
            "完成普通挑战12", "突破无限", "购买5e11突破无限升级",
            "购买全部突破无限升级", "完成所有无限挑战", "解锁复制体",
  ...
  get shortStageNames() {
    return ["4维提", "5维提", "1星系", "无限", "NC12", "破无限", "5e11破无限", "全部破无限", "全部IC",
            "复制体", "ID8", "永恒", "TS61", "TD4", "永恒升级3", "115时间定理", "EC×1", "EC×5", "TS181", "EC10×1",
            "TS192", "EC11", "EC11×5", "膨胀时间", "膨胀永恒", "时间定理生成", "TD8", "现实"];
  },
