export const eternityUpgrades = {
  idMultEP: {
    id: 1,
    cost: 5,
    description: () => `基于未耗永恒点数的无限维度乘数 (x+${formatInt(1)})`,
  ...
  idMultEternities: {
    id: 2,
    cost: 10,
    description: () => `基于永恒数的无限维度乘数
      ((x/${formatInt(200)})^log4(${formatInt(2)}x)，软上限于 ${format(1e5)} 永恒)`,
    effect() {
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ? "时间维度乘以本次末日所经历之天数"
      : (Alpha.isRunning ? "时间维度乘以阿尔法现实中所经历之真实天数"
         : "时间维度乘以游戏天数")
    ),
