export const expansionPacks = {
  ...
  effarigPack: {
    ...
    description: () =>
      ...
      炼金资源在结束游戏中保留，制作现实符文不再消耗现实资源。鹿颈长商店初始完成。
      鹿颈长现实的层级将以你最快结束游戏的十分之一时间自动完成。`,
  ...
  enslavedPack: {
    ...
    description: () =>
      ...
      立方体增加结束游戏数量，同时略微降低无限维度压缩幅度。以完成无名氏开始结束游戏。
      解锁立方体的自动购买器。`,
  ...
  raPack: {
    ...
    symbol: "\uf185",
    description: () =>
      `太阳神在结束游戏中保留。将所有天神的等级上限提高到你记录反物质数量的双对数。
  ...
  laitelaPack: {
    ...
    description: () =>
      ...
      以 ${formatInt(10)} 个奇点开始结束游戏。暗能量产量乘以你奇点数量平方的对数。
