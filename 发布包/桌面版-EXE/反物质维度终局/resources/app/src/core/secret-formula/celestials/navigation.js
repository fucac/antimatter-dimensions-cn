...
export const celestialNavigation = {
  ...
  "teresa-pp-shop": {
    ...
    node: {
      ...
      legend: {
        text: complete => {
          if (complete >= 1) return "特蕾莎的复兴点数商店";
          const rm = Teresa.pouredAmount;
          const cost = TeresaUnlocks.shop.price;
          return [
            "特蕾莎的复兴点数商店",
            `注入 ${format(rm, 2)} / ${format(cost, 2)} 现实机器`
          ];
        },
        angle: -35,
        diagonal: 16,
      ...
      legend: {
        text: complete => {
          ...
          return [
            ...
            `Reach ${format(rs, 2)} / ${format(cost, 2)} 遗迹碎片`
          ];
        },
        angle: 75,
        diagonal: 40,
  ...
  "effarig-eternity": {
    ...
    node: {
      ...
      legend: {
        text: complete => {
          if (complete >= 1) return "Effarig的永恒";
  ...
  "effarig-reality": {
    ...
    node: {
      ...
      legend: {
        text: complete => {
          if (complete >= 1) return "Effarig的现实";
      ...
      legend: {
        text: complete => {
          if (complete < 1) return [
            ...
            "到你无法使用",
            "任何维度的程度",
            `${format(Laitela.difficultyTier)} / ${format(8)} 维度已禁用`
          ];
          return [
            "完全 destabilized",
            "莱特拉的现实",
