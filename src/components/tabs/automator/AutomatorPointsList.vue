...
<template>
  <div>
    ...
    <br>
    <div>
      自动机可以（除其他功能外）购买完整的时间研究树、进入永恒挑战或开启膨胀时间。
      <br>
      它还可以在特定条件下独立于自动购买器强制触发转生事件，或修改部分自动购买器设置。
      <br>
      自动机的速度会随着你获得更多现实而逐渐提升。如果现在解锁，
      它将每实时秒运行 {{ format(1000 / automatorInterval, 2, 2) }} 条命令。
    </div>
  </div>
</template>
