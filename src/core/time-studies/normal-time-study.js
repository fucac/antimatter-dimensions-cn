...
NormalTimeStudies.pathList = [
  ...
  { path: TIME_STUDY_PATH.ACTIVE, studies: [121, 131, 141], name: "主动" },
  { path: TIME_STUDY_PATH.PASSIVE, studies: [122, 132, 142], name: "被动" },
  { path: TIME_STUDY_PATH.IDLE, studies: [123, 133, 143], name: "挂机" },
  { path: TIME_STUDY_PATH.LIGHT, studies: [221, 223, 225, 227, 231, 233], name: "光" },
  { path: TIME_STUDY_PATH.DARK, studies: [222, 224, 226, 228, 232, 234], name: "暗" }
];
