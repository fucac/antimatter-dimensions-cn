...
export const ID = {
  total: {
    name: dim => {
      if (dim) return `ID ${dim} 乘数`;
      if (EternityChallenge(7).isRunning) return "AD7 产出";
      return "无限能产出";
    },
